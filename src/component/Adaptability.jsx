      ...
      <div className="d-flex justify-content-center text-left align-items-center column-reverse-mobile box-container-adapta">
        ...
        <div className="box-text-adapta">
          ...
          <p className="adapta-p">
            Contenido 100% digital con el objetivo de encontrar el balance entre
            tu vida fit, salud mental y alimentación integral a través de sesiones
            personalizadas uno-a-uno, clases en vivo y on demand.
          </p>
        </div>
